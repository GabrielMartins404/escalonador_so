...
// Card de Processo
const ProcessCard = ({ processo, colors, onRemove, tempoRestante, isEspera }) => {
  ...
  return (
    <motion.div className="processo-card" style={{ borderLeft: `4px solid ${colors}` }} initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
...
// Fila de Processos
const Queue = ({ prioridade, processos, color, onRemove }) => {
...
const Escalonador = () => {
  ...
  const [form, setForm] = useState({ prioridade: 1, type: '', time: '' });
  ...
  return (
    <div className="container">
      ...
      <section className="process-table-section">
        <div className="section-header"><h2>Tabela de processos pendentes</h2><Info className="info-icon" size={16} onClick={() => openInfo('table')} /></div>
       ...
       <section className="process-table-section">
        <div className="section-header"><h2>Tabela de processos concluídos</h2><Info className="info-icon" size={16} onClick={() => openInfo('table')} /></div>
        <motion.div className="table-container" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <table className="process-table">
            <thead>
              <tr>
